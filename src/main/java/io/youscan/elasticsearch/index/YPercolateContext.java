...
public class YPercolateContext extends SearchContext {
    ...
    public YPercolateContext(YPercolateShardRequest request, SearchShardTarget searchShardTarget, IndexShard indexShard,
