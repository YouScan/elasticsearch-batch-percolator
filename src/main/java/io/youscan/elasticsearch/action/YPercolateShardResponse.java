...
public class YPercolateShardResponse extends BroadcastShardResponse {
    ...
    YPercolateShardResponse() {
        hls = new ArrayList<>();
    }

    public YPercolateShardResponse(BytesRef[] matches, List<Map<String, HighlightField>> hls, long count, float[] scores, PercolateContext context, ShardId shardId) {
        super(shardId);
    ...
    public YPercolateShardResponse(BytesRef[] matches, long count, float[] scores, PercolateContext context, ShardId shardId) {
        this(matches, EMPTY_HL, count, scores, context, shardId);
    }

    public YPercolateShardResponse(BytesRef[] matches, List<Map<String, HighlightField>> hls, long count, PercolateContext context, ShardId shardId) {
        this(matches, hls, count, EMPTY_SCORES, context, shardId);
    }

    public YPercolateShardResponse(long count, PercolateContext context, ShardId shardId) {
        this(EMPTY_MATCHES, EMPTY_HL, count, EMPTY_SCORES, context, shardId);
    }

    public YPercolateShardResponse(PercolateContext context, ShardId shardId) {
