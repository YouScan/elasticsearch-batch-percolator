 ...
 */
public class YPercolateResponseItem implements Streamable, ToXContent {
    private String docId;
    private Map<String, QueryMatch> matches;

    public YPercolateResponseItem(String docId){
        this.matches = Maps.newHashMap();
        this.docId = docId;
    }

    public YPercolateResponseItem(){
        this.matches = Maps.newHashMap();
    }

    public YPercolateResponseItem(Map<String, QueryMatch> matches, String docId) {
